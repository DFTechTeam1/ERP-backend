...
return [
    ...
    'onlyOneLevelCostCenterParentAllowed' => 'Only 1 level is allowed for cost center item. This selected parent already have a parent data on it',
    ...
    'invoiceChangeRequested' => 'New invoice change request',
    'invoiceChangeRequestedBody' => ':requester requested changes on invoice :invoice for :deal',
    'invoiceChangeApproved' => 'Invoice change approved',
    'invoiceChangeApprovedBody' => 'Your change request on invoice :invoice for :deal was approved',
    'invoiceChangeRejected' => 'Invoice change rejected',
    'invoiceChangeRejectedBody' => 'Your change request on invoice :invoice for :deal was rejected. Reason: :reason',
    ...
    'priceChangesAlreadyDecided' => 'This price change request has already been approved or rejected.',
    'mainInvoiceNotFound' => 'The main invoice for this project deal could not be found.',
    'dealChangesApprovedTitle' => 'Event Changes Approved',
    'dealChangesApprovedMessage' => ':name approved your requested changes on :deal.',
    'dealChangesRejectedTitle' => 'Event Changes Rejected',
    'dealChangesRejectedMessage' => ':name rejected your requested changes on :deal.',
    'requestDealChangesInAppTitle' => 'Event Changes Request',
    'requestDealChangesInAppMessage' => ':name requested changes on :deal (:fields).',
    'requestPriceChangesInAppTitle' => 'Price Change Request',
    'requestPriceChangesInAppMessage' => ':name requested a price change on :deal, from :oldPrice to :newPrice.',
