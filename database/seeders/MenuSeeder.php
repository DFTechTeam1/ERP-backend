...
class MenuSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $menus = [
            ...
            ['app_type' => 'old', 'name' => 'divisions', 'parent_id' => 6, 'icon' => '', 'group' => \App\Enums\Menu\Group::Master->value, 'link' => '/admin/master/divisions', 'permission' => 'list_division', 'lang_id' => 'Divisi', 'lang_en' => 'Divisions'],
            ['app_type' => 'old', 'name' => 'projectClass', 'parent_id' => 6, 'icon' => '', 'group' => \App\Enums\Menu\Group::Master->value, 'link' => '/admin/master/projectClass', 'permission' => 'list_division', 'lang_id' => 'Event Class', 'lang_en' => 'Project Class'],
