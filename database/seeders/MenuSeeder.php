...
class MenuSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $menus = [
            ...
            ['name' => 'fileManager', 'parent_id' => null, 'icon' => 'menus/folder.png', 'group' => \App\Enums\Menu\Group::Production->value, 'link' => '/admin/production/files', 'permission' => 'list_file_manager', 'lang_id' => 'File Manager', 'lang_en' => 'File Manager'],
