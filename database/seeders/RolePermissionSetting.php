...
class RolePermissionSetting extends Seeder
{
    ...
    protected function financePermission()
    {
        return [
            ...
            ['name' => 'reject_project_deal_change', 'group' => 'finance', 'used' => [
                $this->getRootRole(),
                $this->getDirectorRole(),
            ]],
        ];
    ...
    {
        return [
            ['name' => 'assign_deal_to_lead', 'group' => 'production', 'used' => [
                $this->getRootRole(),
                $this->getDirectorRole(),
            ]],
            ...
            ['name' => 'create_pool_task', 'group' => 'production', 'used' => [
                $this->getRootRole(),
                $this->getDirectorRole(),
            ]],
            ['name' => 'list_leads', 'group' => 'production', 'used' => [
                $this->getRootRole(),
                $this->getDirectorRole(),
            ]],
