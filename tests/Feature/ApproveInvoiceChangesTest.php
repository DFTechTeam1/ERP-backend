...
describe('Approve Invoice Changes', function () {
    ...
    it('Approve changes that already approved before', function () {
        ...
        $change = InvoiceRequestUpdate::factory()->create([
            'status' => \App\Enums\Finance\InvoiceRequestUpdateStatus::Approved,
        ...
        Bus::assertNotDispatched(ApproveInvoiceChangesJob::class);
    });
    ...
    it('Approve changes that already other request history for the same invoice id', function () {
        ...
        $change = InvoiceRequestUpdate::factory()
            ->create([
                'invoice_id' => $invoice->id,
                'status' => \App\Enums\Finance\InvoiceRequestUpdateStatus::Pending,
