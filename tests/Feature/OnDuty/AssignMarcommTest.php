...
it ("Assign only marcomm in the main event", function () {
    $project = Project::factory()->create();

    $vj = Employee::factory()->create();

    $response = postJson(route('api.production.incharges.assignMarcomm', ['projectUid' => $project->uid]), [
...
it ('Assign marcomm for afpat and main event', function () {
    $project = Project::factory()->create();
    ...
    assertDatabaseHas('project_marcomm_afpat_attendances', [
        'project_id' => $project->id,
