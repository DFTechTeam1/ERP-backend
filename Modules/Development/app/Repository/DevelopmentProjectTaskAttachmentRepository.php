...
use Modules\Development\Repository\Interface\DevelopmentProjectTaskAttachmentInterface;

class DevelopmentProjectTaskAttachmentRepository extends DevelopmentProjectTaskAttachmentInterface
{
    private $model;
    ...
    {
        $this->model = new DevelopmentProjectTaskAttachment;
        $this->key = 'id';
    }
