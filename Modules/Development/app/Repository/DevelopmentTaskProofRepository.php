...
use Modules\Development\Repository\Interface\DevelopmentTaskProofInterface;

class DevelopmentTaskProofRepository extends DevelopmentTaskProofInterface
{
    private $model;
    ...
    {
        $this->model = new DevelopmentTaskProof;
        $this->key = 'id';
    }
