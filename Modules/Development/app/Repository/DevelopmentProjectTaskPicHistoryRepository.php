...
use Modules\Development\Repository\Interface\DevelopmentProjectTaskPicHistoryInterface;

class DevelopmentProjectTaskPicHistoryRepository extends DevelopmentProjectTaskPicHistoryInterface
{
    private $model;
    ...
    {
        $this->model = new DevelopmentProjectTaskPicHistory;
        $this->key = 'id';
    }
    ...
    {
        return DevelopmentProjectTaskPicHistory::upsert(
            $payload,
            $uniqueBy,
            $updateValue
        );
