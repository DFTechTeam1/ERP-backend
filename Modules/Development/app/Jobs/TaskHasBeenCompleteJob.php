...
class TaskHasBeenCompleteJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        foreach ($employees as $employee) {
            ...
            $message .= "The task {$this->task->name} in event {$this->task->developmentProject->name} has been marked as *Completed*.\n";
