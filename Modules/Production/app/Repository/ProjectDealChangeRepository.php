...
use Modules\Production\Repository\Interface\ProjectDealChangeInterface;

class ProjectDealChangeRepository extends ProjectDealChangeInterface
{
    private $model;
    ...
    {
        $this->model = new ProjectDealChange;
        $this->key = 'id';
    }
