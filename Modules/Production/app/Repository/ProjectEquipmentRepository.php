...
use Modules\Production\Repository\Interface\ProjectEquipmentInterface;

class ProjectEquipmentRepository extends ProjectEquipmentInterface {
    private $model;
    ...
    {
        $this->model = new ProjectEquipment();
        $this->key = 'id';
    }
