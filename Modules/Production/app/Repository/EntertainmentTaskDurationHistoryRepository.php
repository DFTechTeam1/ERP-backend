...
use Modules\Production\Repository\Interface\EntertainmentTaskDurationHistoryInterface;

class EntertainmentTaskDurationHistoryRepository extends EntertainmentTaskDurationHistoryInterface
{
    private $model;
    ...
    {
        $this->model = new EntertainmentTaskDurationHistory;
        $this->key = 'id';
    }
