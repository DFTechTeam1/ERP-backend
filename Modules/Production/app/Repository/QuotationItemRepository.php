...
use Modules\Production\Repository\Interface\QuotationItemInterface;

class QuotationItemRepository extends QuotationItemInterface
{
    private $model;
