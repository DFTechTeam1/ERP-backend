...
use Modules\Production\Repository\Interface\EntertainmentTaskPicWorkstateInterface;

class EntertainmentTaskPicWorkstateRepository extends EntertainmentTaskPicWorkstateInterface
{
    private $model;
    ...
    {
        $this->model = new EntertainmentTaskPicWorkstate;
        $this->key = 'id';
    }
