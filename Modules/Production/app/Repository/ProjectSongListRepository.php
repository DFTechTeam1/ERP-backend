...
use Modules\Production\Repository\Interface\ProjectSongListInterface;

class ProjectSongListRepository extends ProjectSongListInterface {
    private $model;
    ...
    {
        $this->model = new ProjectSongList();
        $this->key = 'id';
    }
