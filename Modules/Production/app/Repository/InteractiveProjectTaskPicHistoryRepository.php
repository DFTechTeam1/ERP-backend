...
use Modules\Production\Repository\Interface\InteractiveProjectTaskPicHistoryInterface;

class InteractiveProjectTaskPicHistoryRepository extends InteractiveProjectTaskPicHistoryInterface
{
    private $model;
    ...
    {
        $this->model = new InteractiveProjectTaskPicHistory;
        $this->key = 'id';
    }
    ...
    {
        return InteractiveProjectTaskPicHistory::upsert(
            $payload,
            $uniqueBy,
            $updateValue
        );
