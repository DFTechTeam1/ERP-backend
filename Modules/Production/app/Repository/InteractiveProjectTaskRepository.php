...
use Modules\Production\Repository\Interface\InteractiveProjectTaskInterface;

class InteractiveProjectTaskRepository extends InteractiveProjectTaskInterface
{
    private $model;
    ...
    {
        $this->model = new InteractiveProjectTask;
        $this->key = 'id';
    }
