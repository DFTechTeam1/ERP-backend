...
use Modules\Production\Repository\Interface\EntertainmentTaskProofOfWorkInterface;

class EntertainmentTaskProofOfWorkRepository extends EntertainmentTaskProofOfWorkInterface
{
    private $model;
    ...
    {
        $this->model = new EntertainmentTaskProofOfWork;
        $this->key = 'id';
    }
