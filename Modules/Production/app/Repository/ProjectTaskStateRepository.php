...
use Modules\Production\Repository\Interface\ProjectTaskStateInterface;

class ProjectTaskStateRepository extends ProjectTaskStateInterface {
    private $model;
    ...
    {
        $this->model = new ProjectTaskState();
        $this->key = 'id';
    }
