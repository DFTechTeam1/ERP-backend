...
use Modules\Production\Repository\Interface\ProjectSongItemInterface;

class ProjectSongItemRepository extends ProjectSongItemInterface
{
    private $model;
    ...
    {
        $this->model = new ProjectSongItem;
        $this->key = 'id';
    }
