...
use Modules\Production\Repository\Interface\ProjectTaskReviseHistoryInterface;

class ProjectTaskReviseHistoryRepository extends ProjectTaskReviseHistoryInterface {
    private $model;
    ...
    {
        $this->model = new ProjectTaskReviseHistory();
        $this->key = 'id';
    }
