...
use Modules\Production\Repository\Interface\EntertainmentTaskPicApprovalstateInterface;

class EntertainmentTaskPicApprovalstateRepository extends EntertainmentTaskPicApprovalstateInterface
{
    private $model;
    ...
    {
        $this->model = new EntertainmentTaskPicApprovalstate;
        $this->key = 'id';
    }
