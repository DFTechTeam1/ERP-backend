...
use Modules\Production\Repository\Interface\ProjectTaskDeadlineInterface;

class ProjectTaskDeadlineRepository extends ProjectTaskDeadlineInterface {
    private $model;
    ...
    {
        $this->model = new ProjectTaskDeadline();
        $this->key = 'id';
    }
