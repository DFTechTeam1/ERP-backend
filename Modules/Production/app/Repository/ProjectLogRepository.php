...
use Modules\Production\Models\ProjectLog;
use Modules\Production\Repository\Interface\ProjectLogInterface;

class ProjectLogRepository extends ProjectLogInterface {
    private $model;
