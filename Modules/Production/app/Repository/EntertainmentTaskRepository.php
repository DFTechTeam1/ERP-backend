...
use Modules\Production\Repository\Interface\EntertainmentTaskInterface;

class EntertainmentTaskRepository extends EntertainmentTaskInterface
{
    private $model;
    ...
    {
        $this->model = new EntertainmentTask;
        $this->key = 'id';
    }
