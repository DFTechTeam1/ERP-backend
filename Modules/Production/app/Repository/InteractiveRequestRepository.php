...
use Modules\Production\Repository\Interface\InteractiveRequestInterface;

class InteractiveRequestRepository extends InteractiveRequestInterface
{
    private $model;
    ...
    {
        $this->model = new InteractiveRequest;
        $this->key = 'id';
    }
