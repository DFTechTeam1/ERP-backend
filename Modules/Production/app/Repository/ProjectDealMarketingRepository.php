...
use Modules\Production\Repository\Interface\ProjectDealMarketingInterface;

class ProjectDealMarketingRepository extends ProjectDealMarketingInterface {
    private $model;
    ...
    {
        $this->model = new ProjectDealMarketing();
        $this->key = 'id';
    }
