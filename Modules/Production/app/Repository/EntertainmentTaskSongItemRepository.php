...
use Modules\Production\Repository\Interface\EntertainmentTaskSongItemInterface;

class EntertainmentTaskSongItemRepository extends EntertainmentTaskSongItemInterface
{
    private $model;
    ...
    {
        $this->model = new EntertainmentTaskSongItem;
        $this->key = 'id';
    }
