...
use Modules\Production\Repository\Interface\EntertainmentTaskPicRevisestateInterface;

class EntertainmentTaskPicRevisestateRepository extends EntertainmentTaskPicRevisestateInterface
{
    private $model;
    ...
    {
        $this->model = new EntertainmentTaskPicRevisestate;
        $this->key = 'id';
    }
