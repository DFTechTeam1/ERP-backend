...
use Modules\Production\Repository\Interface\DeadlineChangeReasonInterface;

class DeadlineChangeReasonRepository extends DeadlineChangeReasonInterface
{
    private $model;
    ...
    {
        $this->model = new DeadlineChangeReason;
        $this->key = 'id';
    }
