...
use Modules\Production\Repository\Interface\EntertainmentLogInterface;

class EntertainmentLogRepository extends EntertainmentLogInterface
{
    private $model;
    ...
    {
        $this->model = new EntertainmentLog;
        $this->key = 'id';
    }
