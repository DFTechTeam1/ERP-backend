...
use Modules\Production\Repository\Interface\EntertainmentTaskPicHoldstateInterface;

class EntertainmentTaskPicHoldstateRepository extends EntertainmentTaskPicHoldstateInterface
{
    private $model;
    ...
    {
        $this->model = new EntertainmentTaskPicHoldstate;
        $this->key = 'id';
    }
