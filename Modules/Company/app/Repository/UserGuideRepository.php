...
use Modules\Company\Models\UserGuide;
use Modules\Company\Repository\Interface\UserGuideInterface;

class UserGuideRepository extends UserGuideInterface {
    private $model;
