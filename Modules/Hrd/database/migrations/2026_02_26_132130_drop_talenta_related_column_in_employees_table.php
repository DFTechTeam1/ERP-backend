...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('employees', function (Blueprint $table) {
            $table->dropColumn('is_sync_with_talenta');
            $table->dropColumn('talenta_user_id');
    ...
    {
        Schema::table('employees', function (Blueprint $table) {
            $table->string('is_sync_with_talenta')->nullable();
            $table->string('talenta_user_id')->nullable();
            ...
            $table->string('overtime_status')->default(false);
