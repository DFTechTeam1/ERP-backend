...
use Modules\Hrd\Repository\Interface\EmployeeTaskPointInterface;

class EmployeeTaskPointRepository extends EmployeeTaskPointInterface {
    private $model;
    ...
    {
        $this->model = new EmployeeTaskPoint();
        $this->key = 'id';
    }
