...
use Modules\Hrd\Repository\Interface\GreatdayJobGradeInterface;

class GreatdayJobGradeRepository extends GreatdayJobGradeInterface {
    private $model;
    ...
    {
        $this->model = new GreatdayJobGrade();
        $this->key = 'id';
    }
