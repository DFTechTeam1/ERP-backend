...
abstract class EmployeePointInterface
{
    ...
    abstract public function show(string $uid, string $select = '*', array $relation = [], string $where = '', array $whereHas = []);

    abstract public function rawSql(string $table, string $select, array $relation = [], string $where = '');
