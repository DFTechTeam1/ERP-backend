...
use Modules\Hrd\Repository\Interface\GreatdayJobStatusInterface;

class GreatdayJobStatusRepository extends GreatdayJobStatusInterface {
    private $model;
    ...
    {
        $this->model = new GreatdayJobStatus();
        $this->key = 'id';
    }
