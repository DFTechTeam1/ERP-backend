...
use Modules\Hrd\Repository\Interface\EmployeeTimeoffInterface;

class EmployeeTimeoffRepository extends EmployeeTimeoffInterface {
    private $model;
    ...
    {
        $this->model = new EmployeeTimeoff();
        $this->key = 'id';
    }
