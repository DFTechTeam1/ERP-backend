...
use Modules\Hrd\Repository\Interface\GreatdayCostCenterInterface;

class GreatdayCostCenterRepository extends GreatdayCostCenterInterface {
    private $model;
    ...
    {
        $this->model = new GreatdayCostCenter();
        $this->key = 'id';
    }
