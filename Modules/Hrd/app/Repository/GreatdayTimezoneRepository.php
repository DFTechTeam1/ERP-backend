...
use Modules\Hrd\Repository\Interface\GreatdayTimezoneInterface;

class GreatdayTimezoneRepository extends GreatdayTimezoneInterface {
    private $model;
    ...
    {
        $this->model = new GreatdayTimezone();
        $this->key = 'id';
    }
