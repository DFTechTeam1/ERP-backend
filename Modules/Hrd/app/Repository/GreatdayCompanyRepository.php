...
use Modules\Hrd\Repository\Interface\GreatdayCompanyInterface;

class GreatdayCompanyRepository extends GreatdayCompanyInterface {
    private $model;
    ...
    {
        $this->model = new GreatdayCompany();
        $this->key = 'id';
    }
