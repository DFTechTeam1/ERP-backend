...
return new class extends Migration
{
    ...
    {
        Schema::create('project_equipment_brokens', function (Blueprint $table) {
            $table->id();
            $table->uuid('uid');
    ...
    {
        // Drop foreign key
        Schema::table('project_equipment_brokens', function (Blueprint $table) {
        ...
        Schema::dropIfExists('project_equipment_brokens');
    }
};
