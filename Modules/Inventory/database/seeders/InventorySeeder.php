...
class InventorySeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $data = [
            ...
            ['slug' => $monitor->slug, 'name' => 'ViewSonic VX2416', 'item_type' => $monitor->id, 'brand_id' => $viewsonic->id, 'supplier_id' => $tokped->id, 'description' => null, 'warranty' => 2, 'year_of_purchase' => '2023', 'purchase_price' => '1509000', 'unit_id' => $unit->id, 'stock' => 2],
