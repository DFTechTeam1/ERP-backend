...
use Modules\Inventory\Repository\Interface\CustomInventoryDetailInterface;

class CustomInventoryDetailRepository extends CustomInventoryDetailInterface
{
    private $model;
    ...
    {
        $this->model = new CustomInventoryDetail;
        $this->key = 'id';
    }
