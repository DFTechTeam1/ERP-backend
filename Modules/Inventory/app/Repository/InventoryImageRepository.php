...
use Modules\Inventory\Models\InventoryImage;
use Modules\Inventory\Repository\Interface\InventoryImageInterface;

class InventoryImageRepository extends InventoryImageInterface
{
    private $model;
