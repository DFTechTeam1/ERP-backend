...
use Modules\Inventory\Repository\Interface\InventoryTypeInterface;

class InventoryTypeRepository extends InventoryTypeInterface
{
    private $model;
