...
use Modules\Finance\Repository\Interface\ProjectDealPriceChangeInterface;

class ProjectDealPriceChangeRepository extends ProjectDealPriceChangeInterface
{
    private $model;
    ...
    {
        $this->model = new ProjectDealPriceChange;
        $this->key = 'id';
    }
