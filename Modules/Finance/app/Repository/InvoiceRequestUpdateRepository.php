...
use Modules\Finance\Repository\Interface\InvoiceRequestUpdateInterface;

class InvoiceRequestUpdateRepository extends InvoiceRequestUpdateInterface {
    private $model;
    ...
    {
        $this->model = new InvoiceRequestUpdate();
        $this->key = 'id';
    }
