...
use Modules\Finance\Repository\Interface\PriceChangeReasonInterface;

class PriceChangeReasonRepository extends PriceChangeReasonInterface {
    private $model;
    ...
    {
        $this->model = new PriceChangeReason();
        $this->key = 'id';
    }
