...
class NotifyInteractiveTaskAssigneeJob implements ShouldQueue
{
     ...
     */
    public function __construct(array $asignessIds, Collection|InteractiveProjectTask $task)
    {
    ...
    public function handle(): void
    {
        ...
        $isAlreadyRunning = $this->task->status == InteractiveTaskStatus::InProgress ? true : false;
