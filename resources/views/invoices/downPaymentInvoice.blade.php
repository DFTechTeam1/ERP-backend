                ...
                <tr>
                    <td>
                        <div class="list-products">
                            <p id="type-payment" style="margin-bottom: 8px; font-weight: bold;">Pembayaran DP</p>
        ...
        <table class="total">
            <tbody>
                <tr>
                    ...
                    <td style="width: 22%; color: #353434;">{{ $amountRequest }}</td>
                </tr>
                ...
                <tr>
                    ...
                    <td style="width: 22%; border-bottom: unset; font-weight: bold; color: #181717;">{{ $amountRequest }}</td>
                </tr>
            </tbody>
        </table>
