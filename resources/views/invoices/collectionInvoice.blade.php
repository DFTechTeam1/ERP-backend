                ...
                <tr>
                    <td>
                        <div class="list-products">
                            <p id="type-payment" style="margin-bottom: 8px; font-weight: bold;">
                                Pembayaran @if ($isDownPayment) DP @endif
                            </p>
        ...
        <table class="total">
            <tbody>
                ...
                <tr>
                    ...
                    <td style="width: 22%; border-bottom: unset; font-weight: bold; color: #181717;">{{ $payment }}</td>
                </tr>
            </tbody>
        </table>
