...
<body>
                                        ...
                                        <table>
                                            <tr>
                                                ...
                                                <td style="font-weight: normal; padding-left: 20px;">
                                                    <p style="font-weight: bold; margin-top: -20px;">Premium LED Visual</p>
                    ...
                    <table class="table-rules">
                        <tbody>
                            <tr>
                                <td>
                                    <div>
                                        <ul style="list-style: circle; padding-left: 10px; padding-top: 0; font-size: 12px; line-height: 1.2;">
    ...
    <table class="main-wrapper">
        <tbody>
            ...
            <tr>
                <td colspan="2">
                    <div class="conditions" style="font-size: 12px; margin-top: -150px;">
                        ...
                        <ul style="padding-left: 20px; padding-top: 10px; width: 70%; font-size: 13px; line-height: 1.2; text-align: justify;">
                            <li>
            ...
            <tr>
                <td colspan="2">
                    <div class="conditions" style="font-size: 12px; margin-top: -150px;">
                        ...
                        <ul style="padding-left: 20px; padding-top: 10px; width: 65%; font-size: 12px; line-height: 1.2; list-style:upper-roman; text-align: justify;">
                            <li>
