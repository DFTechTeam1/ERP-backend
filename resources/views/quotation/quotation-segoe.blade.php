...
<head>
    ...
    <style>
        @font-face {
            ...
            font-style: normal;
            font-weight: normal;
            src: local('Segoe UI Regular'), url({{ public_path('fonts/segoe.woff') }}) format('woff');
        }
...
<body>
                                        ...
                                        <table>
                                            <tr>
                                                ...
                                                <td style="font-weight: normal; padding-left: 20px;">
                                                    <p style="font-weight: bold;">Premium LED Visual</p>
            
                                                    <ul style="padding-left: 55px; padding-top: 5px; margin-top: 0;">
                    ...
                    <table class="table-rules">
                        <tbody>
                            <tr>
                                <td>
                                    <div>
                                        <ul style="list-style: circle; padding-left: 10px; padding-top: 0; font-size: 13px; line-height: 1.5;">
    ...
    <table class="main-wrapper">
        <tbody>
            ...
            <tr>
                <td colspan="2">
                    <div class="conditions" style="font-size: 12px; margin-top: -90px;">
                        <p class="condition-title" style="font-size: 20px; font-weight: bold; margin: 0;">Detail Penawaran (Custom Content)</p>
                        <p style="text-wrap: wrap; width: 80%;"><span style="font-weight: bold; margin: 0;">DFACTORY</span>5sebagai penyedia jasa layanan konten digital LED menyiapkan konten dengan tahapan pengerjaan sebagai berikut :</p>
